...
ascii_spaces = " " * 20  # 20 spaces 
message_spaces = " " * 30  # 30 spaces
...
def print_ascii_once():
    ...
    for i, line in enumerate(ascii_art):
        ...
        slow_print(color + ascii_spaces + line + "\033[0m")  
    slow_print(welcome_color + "\n" + message_spaces + "Welcome to the FaxterGPT chat!\033[0m")  
...
while True:
    user_input = input(user_input_color + "You: \033[0m")  
    if user_input.lower() == "leave":
        slow_print("\n" + bot_response_color + "Bot: Goodbye!\033[0m")  
        break
